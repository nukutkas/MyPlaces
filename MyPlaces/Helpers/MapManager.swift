...
//  MyPlaces
//
//  Created by Татьяна Кочетова on 14.09.2020.
...
class MapManager {
    ...
    func checkLocationAuthorization(mapView: MKMapView, segueIdentifier: String) {
        ...
        case .denied:
            DispatchQueue.main.asyncAfter(deadline: .now() + 1) {
                self.showAlert(
                    title: "Your location is now available",
    ...
    //Настройка запроса для расчета формул
    ...
    func startTrackingUserLocaiton(for mapView: MKMapView, and location: CLLocation?, closure: (_ currentLocation: CLLocation) -> ()) {
